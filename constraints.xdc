...
set_property PACKAGE_PIN AY37 [get_ports clk]
...
set_property PACKAGE_PIN BD21 [get_ports button]
...
set_property PACKAGE_PIN AT20 [get_ports colour_0]
set_property IOSTANDARD LVCMOS18 [get_ports colour_0]

set_property PACKAGE_PIN AT20 [get_ports colour_1]
set_property IOSTANDARD LVCMOS18 [get_ports colour_1]

set_property PACKAGE_PIN AT20 [get_ports colour_2]
set_property IOSTANDARD LVCMOS18 [get_ports colour_2]
